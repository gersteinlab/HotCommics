                               ...
                               if line.split()[7].split(':')[transcriptIndex+index] ==  [item[1] for item in bioMartInfo][member]:
                                  ...
                                  try:    
                                     ...
                                     if sequence[mutationIndex] == origResidue:
                                        ...
                                        snpAttribute = line.split()[7].split(';')[0] # Additional SNP attributes: VAF,geneName etc. 


                                        if str(snpAttribute.split('|')[-1:][0])  == str(line.split()[7].split(':')[transcriptIndex+index].split('.')[0]):
                                          ...
                                          fileOut.write(line.split()[7].split(':')[element-2]+"\t"+SNPINFO+'\t'+snpAttribute+'\t'+line.split()[7].split(':')[element]+"\t"+line.split()[7].split(':')[transcriptIndex+index]+"\t"+line.split()[7].split(':')[transcriptIndex+index+1]+"\t"+str(sequence))
